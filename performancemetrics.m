...
for i = st:st+N
   ...
   tname = '/media/jeyamariajose/7888230b-5c10-4229-90f2-c78bdae9c5de/Data/Projects/gpseg/results/10syn/';
   imgname = strcat(tname,num2str(10*k),'/',num2str(i,'%04d'),'.png');
   lname = '/media/jeyamariajose/7888230b-5c10-4229-90f2-c78bdae9c5de/Data/Brain_Ultrasound/Final/unet/test/labelcol/';
